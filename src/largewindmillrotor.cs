...
{
    public class BlockLargeWindmillRotor : BlockMPBase
    {
        ...
        {
            BEBehaviorLargeWindmillRotor be = world.BlockAccessor.GetBlockEntity(blockSel.Position)?.GetBehavior<BEBehaviorLargeWindmillRotor>();
        ...
        {
            BEBehaviorLargeWindmillRotor be = world.BlockAccessor.GetBlockEntity(selection.Position)?.GetBehavior<BEBehaviorLargeWindmillRotor>();
            ...
            return new WorldInteraction[]
            {
                new WorldInteraction()
                {
                    ...
                    Itemstacks = new ItemStack[] { new ItemStack(world.GetItem(new AssetLocation("biggerwindmill:largesail")), 4) }
                }
            };
        }
